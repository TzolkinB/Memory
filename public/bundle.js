...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__createHashHistory__ = __webpack_require__(40);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_1__createHashHistory__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__createMemoryHistory__ = __webpack_require__(41);
...
*/
var aa=__webpack_require__(9),ca=__webpack_require__(0),m=__webpack_require__(27),p=__webpack_require__(6),v=__webpack_require__(7),da=__webpack_require__(28),ea=__webpack_require__(29),fa=__webpack_require__(30),ha=__webpack_require__(10);
...
var AppBar = function AppBar() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'nav',
      { className: 'navbar navbar-expand-lg text-white bg-primary navbar-dark' },
      _react2.default.createElement(
        'a',
...
var Footer = function Footer() {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'ul',
        { className: 'list-inline font-weight-light' },
        _react2.default.createElement(
          'li',
          { className: 'list-inline-item' },
          _react2.default.createElement(
            _reactRouterDom.Link,
            { to: '#', target: '_blank', className: 'text-white' },
            'Link 1'
          )
        ),
        _react2.default.createElement(
...
var _Card = __webpack_require__(77);

var _Card2 = _interopRequireDefault(_Card);

var _robots = __webpack_require__(78);
...
var shuffle = function shuffle(robots) {
  robots.sort(function () {
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.state = {
      shuffleBots: shuffle(_robots.robots),
      selected: [],
      bluePlayer: {
        active: true,
        matches: 0
  ...
  _createClass(App, [{
    key: 'reShuffle',
    value: function reShuffle(bots) {
      var _state = this.state,
          shuffleBots = _state.shuffleBots,
          selected = _state.selected,
          bluePlayer = _state.bluePlayer;
      ...
      shuffleBots.forEach(function (bot) {
        return bot.isFaceUp = false;
      });
    }
  }, {
    key: 'playerInfo',
    value: function playerInfo() {
      if (this.state.bluePlayer.active) {
        return _react2.default.createElement(
          'p',
          { className: 'player-text text-info' },
          'Blue Player\'s Turn'
        );
      }
      return _react2.default.createElement(
        'p',
        { className: 'player-text text-danger' },
        'Red Player\'s Turn'
      );
    }
  }, {
    ...
    value: function render() {
      ...
      var _state2 = this.state,
          shuffleBots = _state2.shuffleBots,
          selected = _state2.selected,
          bluePlayer = _state2.bluePlayer,
          redPlayer = _state2.redPlayer;


      var handleFlip = function handleFlip(robot, index) {
        console.log('flip');
        var id = robot.id;
        ...
        if (selected && selected.length <= 1) {
          ...
          _this2.setState(function (prevState) {
            return {
              selected: [].concat(_toConsumableArray(prevState.selected), [id])
            };
          });
        }
      ...
      var handleMatch = function handleMatch() {
        var _state3 = _this2.state,
            shuffleBots = _state3.shuffleBots,
            selected = _state3.selected,
            bluePlayer = _state3.bluePlayer,
            redPlayer = _state3.redPlayer;
        ...
        bluePlayer.active = !bluePlayer.active, redPlayer.active = !bluePlayer.active, _this2.setState({ selected: [], bluePlayer: bluePlayer, redPlayer: redPlayer });
      };
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'info d-flex justify-content-between mt-4' },
          _react2.default.createElement(
            'button',
            {
              type: 'button',
              onClick: function onClick(e) {
                return _this2.reShuffle(shuffleBots);
              },
        ...
        _react2.default.createElement(
          'div',
          { className: 'card-deck' },
          _react2.default.createElement(_Card2.default, { shuffleBots: shuffleBots, handleFlip: handleFlip })
        )
      );
    }
  }]);
...
var Card = function Card(props) {
  var shuffleBots = props.shuffleBots,
      handleFlip = props.handleFlip;

  return _react2.default.createElement(
    _react2.default.Fragment,
    null,
    shuffleBots.map(function (robot, i) {
      return _react2.default.createElement(
        'div',
        { className: 'card', key: i, onClick: function onClick() {
            return handleFlip(robot, i);
          } },
        _react2.default.createElement(
          'div',
          { className: 'card-body ' + (robot.isFaceUp ? '' : 'card-back') },
          _react2.default.createElement('img', { role: 'presentation', src: 'https://robohash.org/' + robot.id, height: '150', width: '150' })
        )
      );
    })
  );
...
var robots = exports.robots = [{ id: 1, isFaceUp: false }, { id: 1, isFaceUp: false }, { id: 2, isFaceUp: false }, { id: 2, isFaceUp: false }, { id: 3, isFaceUp: false }, { id: 3, isFaceUp: false }, { id: 5, isFaceUp: false }, { id: 5, isFaceUp: false }, { id: 12, isFaceUp: false }, { id: 12, isFaceUp: false }, { id: 13, isFaceUp: false }, { id: 13, isFaceUp: false }];
